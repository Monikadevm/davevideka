...
= 3.4.7 Mar 09, 2022 =
* New: Gutenberg Block for Logo Carousel shortcode.
* New: The alt attribute to the preloader image has been added.
* New: Specific class added in the logo image tag to exclude lazyload conflict of other plugins.
* Fix: Image vertically middle/center does not work.
* Fix: Custom CSS loads multiple times if multiple shortcodes are used on a page.

= 3.4.6 Jan 26, 2022 =
* Tested: WordPress 5.9 compatibility.

= 3.4.5 Dec 21, 2021 =
* Fix: Image tag title attr double quote issue.
* Improved: Plugin security improved.

= 3.4.4 Dec 14, 2021 =
* Improved: Shortcode duplication nonce sanitized.
